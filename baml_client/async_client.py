...
class BamlAsyncClient:
    ...
    async def EvaluateResumes(
        self,
        input_resume: str,reference_resume: str,
        baml_options: BamlCallOptions = {},
    ) -> types.ResumeEvaluation:
      ...
      raw = await self.__runtime.call_function(
        "EvaluateResumes",
        {
          "input_resume": input_resume,"reference_resume": reference_resume,
        },
      ...
      return cast(types.ResumeEvaluation, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def EvaluateResumes(
        ...
        input_resume: str,reference_resume: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.ResumeEvaluation, types.ResumeEvaluation]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.ResumeEvaluation, types.ResumeEvaluation](
        raw,
        lambda x: cast(partial_types.ResumeEvaluation, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.ResumeEvaluation, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
